...
public class ReferenceExpression implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: reference_expression")
    public ReferenceExpression(Long elementHashId) {
    ...
    public boolean equals(Object that) {
        ...
        ReferenceExpression other = (ReferenceExpression) that;
