...
public class TypeElement implements Serializable {
    ...
    private Long referenceTypeHashId;
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: type_element")
    public TypeElement(Long elementHashId, Long referenceTypeHashId, String debugMessage, Long parentHashId, Long locationHashId) {
        this.elementHashId = elementHashId;
        this.referenceTypeHashId = referenceTypeHashId;
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: type_element.reference_type_hash_id")
    public Long getReferenceTypeHashId() {
        return referenceTypeHashId;
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: type_element.reference_type_hash_id")
    public void setReferenceTypeHashId(Long referenceTypeHashId) {
        this.referenceTypeHashId = referenceTypeHashId;
    }
    ...
    public boolean equals(Object that) {
        ...
        TypeElement other = (TypeElement) that;
        return (this.getElementHashId() == null ? other.getElementHashId() == null : this.getElementHashId().equals(other.getElementHashId()))
            && (this.getReferenceTypeHashId() == null ? other.getReferenceTypeHashId() == null : this.getReferenceTypeHashId().equals(other.getReferenceTypeHashId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getReferenceTypeHashId() == null) ? 0 : getReferenceTypeHashId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", referenceTypeHashId=").append(referenceTypeHashId);
