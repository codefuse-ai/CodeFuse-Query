...
public class SuperExpressionWithQualifier implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: super_expression_with_qualifier")
    public SuperExpressionWithQualifier(Long elementHashId, Long qualifierHashId) {
    ...
    public boolean equals(Object that) {
        ...
        SuperExpressionWithQualifier other = (SuperExpressionWithQualifier) that;
