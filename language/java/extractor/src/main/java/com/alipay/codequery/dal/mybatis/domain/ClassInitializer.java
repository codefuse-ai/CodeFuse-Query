...
public class ClassInitializer implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: class_initializer")
    public ClassInitializer(Long elementHashId, String debugMessage, Long parentHashId, Long locationHashId) {
    ...
    public boolean equals(Object that) {
        ...
        ClassInitializer other = (ClassInitializer) that;
