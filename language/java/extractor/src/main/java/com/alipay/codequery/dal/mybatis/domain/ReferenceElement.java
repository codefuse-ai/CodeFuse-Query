...
public class ReferenceElement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: reference_element")
    public ReferenceElement(Long elementHashId, String debugMessage, Long parentHashId, Long locationHashId) {
    ...
    public boolean equals(Object that) {
        ...
        ReferenceElement other = (ReferenceElement) that;
