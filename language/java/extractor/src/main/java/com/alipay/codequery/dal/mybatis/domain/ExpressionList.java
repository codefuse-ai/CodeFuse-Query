...
public class ExpressionList implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: expression_list")
    public ExpressionList(Long elementHashId, Long parentHashId, Long locationHashId, String debugMessage, Integer size) {
    ...
    public boolean equals(Object that) {
        ...
        ExpressionList other = (ExpressionList) that;
