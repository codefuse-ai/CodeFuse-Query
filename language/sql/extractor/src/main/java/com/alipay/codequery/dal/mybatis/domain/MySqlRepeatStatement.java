...
public class MySqlRepeatStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_repeat_statement")
    public MySqlRepeatStatement(Long oid, Long conditionOid, String labelName) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlRepeatStatement other = (MySqlRepeatStatement) that;
