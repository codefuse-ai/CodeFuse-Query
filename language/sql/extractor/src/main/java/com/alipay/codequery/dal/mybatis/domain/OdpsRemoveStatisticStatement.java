...
public class OdpsRemoveStatisticStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: odps_remove_statistic_statement")
    public OdpsRemoveStatisticStatement(Long oid, Long statisticClauseOid, Long tableOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OdpsRemoveStatisticStatement other = (OdpsRemoveStatisticStatement) that;
