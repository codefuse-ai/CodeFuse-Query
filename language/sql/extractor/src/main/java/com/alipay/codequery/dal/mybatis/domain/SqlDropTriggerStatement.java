...
public class SqlDropTriggerStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_trigger_statement")
    public SqlDropTriggerStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropTriggerStatement other = (SqlDropTriggerStatement) that;
