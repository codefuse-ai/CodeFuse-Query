...
public class SqlAlterTableDropExtPartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_drop_ext_partition")
    public SqlAlterTableDropExtPartition(Long oid, Long extPartitionOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableDropExtPartition other = (SqlAlterTableDropExtPartition) that;
