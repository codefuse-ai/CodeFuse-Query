...
public class SqlAlterTableUnarchivePartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_unarchive_partition")
    public SqlAlterTableUnarchivePartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableUnarchivePartition other = (SqlAlterTableUnarchivePartition) that;
