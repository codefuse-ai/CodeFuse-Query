...
public class SqlAlterTableAnalyzePartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_analyze_partition")
    public SqlAlterTableAnalyzePartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableAnalyzePartition other = (SqlAlterTableAnalyzePartition) that;
