...
public class PgConnectToStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_connect_to_statement")
    public PgConnectToStatement(Long oid, Long targetOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        PgConnectToStatement other = (PgConnectToStatement) that;
