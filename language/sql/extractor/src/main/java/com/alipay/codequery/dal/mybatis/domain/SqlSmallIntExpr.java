...
public class SqlSmallIntExpr implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_small_int_expr")
    public SqlSmallIntExpr(Long oid, String number, Integer value) {
        this.oid = oid;
        this.number = number;
        this.value = value;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlSmallIntExpr other = (SqlSmallIntExpr) that;
