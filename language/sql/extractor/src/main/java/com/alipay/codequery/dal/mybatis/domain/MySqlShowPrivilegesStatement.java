...
public class MySqlShowPrivilegesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_privileges_statement")
    public MySqlShowPrivilegesStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowPrivilegesStatement other = (MySqlShowPrivilegesStatement) that;
