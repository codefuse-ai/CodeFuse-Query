...
public class SqlPurgeTemporaryOutputStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_purge_temporary_output_statement")
    public SqlPurgeTemporaryOutputStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlPurgeTemporaryOutputStatement other = (SqlPurgeTemporaryOutputStatement) that;
