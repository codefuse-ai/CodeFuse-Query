...
public class MysqlShowHtcStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: mysql_show_htc_statement")
    public MysqlShowHtcStatement(Long oid, Integer isFull, Integer isHis) {
        this.oid = oid;
        this.isFull = isFull;
        this.isHis = isHis;
    }
    ...
    public boolean equals(Object that) {
        ...
        MysqlShowHtcStatement other = (MysqlShowHtcStatement) that;
