...
public class OracleBinaryFloatExpr implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_binary_float_expr")
    public OracleBinaryFloatExpr(Long oid, String number, String value) {
        this.oid = oid;
        this.number = number;
        this.value = value;
    }
    ...
    public boolean equals(Object that) {
        ...
        OracleBinaryFloatExpr other = (OracleBinaryFloatExpr) that;
