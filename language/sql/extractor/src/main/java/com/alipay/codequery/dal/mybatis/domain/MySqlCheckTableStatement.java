...
public class MySqlCheckTableStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_check_table_statement")
    public MySqlCheckTableStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlCheckTableStatement other = (MySqlCheckTableStatement) that;
