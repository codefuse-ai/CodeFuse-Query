...
public class SqlShowCreateMaterializedViewStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_create_materialized_view_statement")
    public SqlShowCreateMaterializedViewStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowCreateMaterializedViewStatement other = (SqlShowCreateMaterializedViewStatement) that;
