...
public class MySqlSubPartitionByKey implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_sub_partition_by_key")
    public MySqlSubPartitionByKey(Long oid, Integer algorithm) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlSubPartitionByKey other = (MySqlSubPartitionByKey) that;
