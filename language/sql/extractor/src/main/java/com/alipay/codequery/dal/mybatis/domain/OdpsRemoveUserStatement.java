...
public class OdpsRemoveUserStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: odps_remove_user_statement")
    public OdpsRemoveUserStatement(Long oid, Long userOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OdpsRemoveUserStatement other = (OdpsRemoveUserStatement) that;
