...
public class MySqlShowRuleStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_rule_statement")
    public MySqlShowRuleStatement(Long oid, Integer isFull, Integer isVersion, Long limitOid, Long nameOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
        this.isFull = isFull;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowRuleStatement other = (MySqlShowRuleStatement) that;
