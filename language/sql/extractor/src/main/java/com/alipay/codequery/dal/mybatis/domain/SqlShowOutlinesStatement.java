...
public class SqlShowOutlinesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_outlines_statement")
    public SqlShowOutlinesStatement(Long oid, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowOutlinesStatement other = (SqlShowOutlinesStatement) that;
