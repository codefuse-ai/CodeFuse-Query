...
public class SqlShowTableGroupsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_table_groups_statement")
    public SqlShowTableGroupsStatement(Long oid, Long databaseOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowTableGroupsStatement other = (SqlShowTableGroupsStatement) that;
