...
public class SqlExplainAnalyzeStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_explain_analyze_statement")
    public SqlExplainAnalyzeStatement(Long oid, Long selectOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlExplainAnalyzeStatement other = (SqlExplainAnalyzeStatement) that;
