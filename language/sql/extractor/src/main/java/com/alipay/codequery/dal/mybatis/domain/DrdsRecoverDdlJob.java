...
public class DrdsRecoverDdlJob implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: drds_recover_ddl_job")
    public DrdsRecoverDdlJob(Long oid, Integer isAllJobs, String jobIds) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        DrdsRecoverDdlJob other = (DrdsRecoverDdlJob) that;
