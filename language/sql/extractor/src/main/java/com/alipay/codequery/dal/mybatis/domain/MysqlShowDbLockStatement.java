...
public class MysqlShowDbLockStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: mysql_show_db_lock_statement")
    public MysqlShowDbLockStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MysqlShowDbLockStatement other = (MysqlShowDbLockStatement) that;
