...
public class SqlTableDataType implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_table_data_type")
    public SqlTableDataType(Long oid, Integer isInt, Integer isNumberic, Integer isString, Integer isWithLocalTimeZone, String name, Integer withTimeZone) {
        this.oid = oid;
        this.isInt = isInt;
    ...
    public boolean equals(Object that) {
        ...
        SqlTableDataType other = (SqlTableDataType) that;
