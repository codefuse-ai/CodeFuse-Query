...
public class SqlShowStatisticListStmt implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_statistic_list_stmt")
    public SqlShowStatisticListStmt(Long oid, Integer isFull, Long tableSourceOid) {
        this.oid = oid;
        this.isFull = isFull;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowStatisticListStmt other = (SqlShowStatisticListStmt) that;
