...
public class MySqlShowCreateTriggerStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_create_trigger_statement")
    public MySqlShowCreateTriggerStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowCreateTriggerStatement other = (MySqlShowCreateTriggerStatement) that;
