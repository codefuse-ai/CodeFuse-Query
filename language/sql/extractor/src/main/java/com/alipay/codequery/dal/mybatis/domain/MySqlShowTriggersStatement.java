...
public class MySqlShowTriggersStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_triggers_statement")
    public MySqlShowTriggersStatement(Long oid, Long databaseOid, Long likeOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowTriggersStatement other = (MySqlShowTriggersStatement) that;
