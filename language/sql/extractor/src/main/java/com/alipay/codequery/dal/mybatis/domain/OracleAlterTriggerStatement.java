...
public class OracleAlterTriggerStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_alter_trigger_statement")
    public OracleAlterTriggerStatement(Long oid, Integer enable, Integer isCompile, Long nameOid) {
        this.oid = oid;
        this.enable = enable;
    ...
    public boolean equals(Object that) {
        ...
        OracleAlterTriggerStatement other = (OracleAlterTriggerStatement) that;
