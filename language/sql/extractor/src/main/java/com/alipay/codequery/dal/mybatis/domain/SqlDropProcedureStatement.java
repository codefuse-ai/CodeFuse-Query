...
public class SqlDropProcedureStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_procedure_statement")
    public SqlDropProcedureStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropProcedureStatement other = (SqlDropProcedureStatement) that;
