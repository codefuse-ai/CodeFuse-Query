...
public class OdpsAlterTableSetChangeLogs implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: odps_alter_table_set_change_logs")
    public OdpsAlterTableSetChangeLogs(Long oid, Long valueOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OdpsAlterTableSetChangeLogs other = (OdpsAlterTableSetChangeLogs) that;
