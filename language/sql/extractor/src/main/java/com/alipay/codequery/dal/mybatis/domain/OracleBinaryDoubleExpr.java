...
public class OracleBinaryDoubleExpr implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_binary_double_expr")
    public OracleBinaryDoubleExpr(Long oid, String number, String value) {
        this.oid = oid;
        this.number = number;
        this.value = value;
    }
    ...
    public boolean equals(Object that) {
        ...
        OracleBinaryDoubleExpr other = (OracleBinaryDoubleExpr) that;
