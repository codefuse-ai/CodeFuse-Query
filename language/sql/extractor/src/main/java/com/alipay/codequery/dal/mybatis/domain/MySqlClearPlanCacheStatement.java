...
public class MySqlClearPlanCacheStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_clear_plan_cache_statement")
    public MySqlClearPlanCacheStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlClearPlanCacheStatement other = (MySqlClearPlanCacheStatement) that;
