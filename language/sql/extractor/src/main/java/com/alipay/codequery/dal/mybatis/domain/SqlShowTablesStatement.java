...
public class SqlShowTablesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_tables_statement")
    public SqlShowTablesStatement(Long oid, Long databaseOid, Long fromOid, Integer isExtended, Integer isFull, Long likeOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowTablesStatement other = (SqlShowTablesStatement) that;
