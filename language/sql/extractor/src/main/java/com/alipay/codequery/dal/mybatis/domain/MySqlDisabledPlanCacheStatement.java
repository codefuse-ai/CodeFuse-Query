...
public class MySqlDisabledPlanCacheStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_disabled_plan_cache_statement")
    public MySqlDisabledPlanCacheStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlDisabledPlanCacheStatement other = (MySqlDisabledPlanCacheStatement) that;
