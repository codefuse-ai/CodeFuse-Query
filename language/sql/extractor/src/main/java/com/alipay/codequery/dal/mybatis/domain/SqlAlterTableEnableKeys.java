...
public class SqlAlterTableEnableKeys implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_enable_keys")
    public SqlAlterTableEnableKeys(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableEnableKeys other = (SqlAlterTableEnableKeys) that;
