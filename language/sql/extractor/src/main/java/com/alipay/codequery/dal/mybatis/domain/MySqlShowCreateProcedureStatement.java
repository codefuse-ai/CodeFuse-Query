...
public class MySqlShowCreateProcedureStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_create_procedure_statement")
    public MySqlShowCreateProcedureStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowCreateProcedureStatement other = (MySqlShowCreateProcedureStatement) that;
