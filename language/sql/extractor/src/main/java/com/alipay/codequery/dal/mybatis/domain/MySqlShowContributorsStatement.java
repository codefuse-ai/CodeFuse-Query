...
public class MySqlShowContributorsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_contributors_statement")
    public MySqlShowContributorsStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowContributorsStatement other = (MySqlShowContributorsStatement) that;
