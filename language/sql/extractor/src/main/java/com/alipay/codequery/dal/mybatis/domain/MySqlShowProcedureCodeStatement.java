...
public class MySqlShowProcedureCodeStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_procedure_code_statement")
    public MySqlShowProcedureCodeStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowProcedureCodeStatement other = (MySqlShowProcedureCodeStatement) that;
