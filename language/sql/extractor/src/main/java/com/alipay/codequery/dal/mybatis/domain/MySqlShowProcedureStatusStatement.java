...
public class MySqlShowProcedureStatusStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_procedure_status_statement")
    public MySqlShowProcedureStatusStatement(Long oid, Long likeOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowProcedureStatusStatement other = (MySqlShowProcedureStatusStatement) that;
