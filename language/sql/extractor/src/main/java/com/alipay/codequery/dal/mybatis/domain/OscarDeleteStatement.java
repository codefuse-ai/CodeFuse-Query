...
public class OscarDeleteStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oscar_delete_statement")
    public OscarDeleteStatement(Long oid, String alias, Integer isReturning) {
        this.oid = oid;
        this.alias = alias;
    ...
    public boolean equals(Object that) {
        ...
        OscarDeleteStatement other = (OscarDeleteStatement) that;
