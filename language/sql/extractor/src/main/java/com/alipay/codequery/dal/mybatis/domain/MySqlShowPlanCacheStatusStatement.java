...
public class MySqlShowPlanCacheStatusStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_plan_cache_status_statement")
    public MySqlShowPlanCacheStatusStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowPlanCacheStatusStatement other = (MySqlShowPlanCacheStatusStatement) that;
