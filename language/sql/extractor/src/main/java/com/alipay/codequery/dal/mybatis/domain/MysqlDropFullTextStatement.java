...
public class MysqlDropFullTextStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: mysql_drop_full_text_statement")
    public MysqlDropFullTextStatement(Long oid, Long nameOid, String type) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MysqlDropFullTextStatement other = (MysqlDropFullTextStatement) that;
