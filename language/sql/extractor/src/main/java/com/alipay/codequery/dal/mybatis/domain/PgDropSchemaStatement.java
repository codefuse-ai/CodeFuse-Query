...
public class PgDropSchemaStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_drop_schema_statement")
    public PgDropSchemaStatement(Long oid, Integer isCascade, Integer isIfExists, Integer isRestrict, Long schemaNameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        PgDropSchemaStatement other = (PgDropSchemaStatement) that;
