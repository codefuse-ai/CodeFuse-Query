...
public class SqlIntervalExpr implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_interval_expr")
    public SqlIntervalExpr(Long oid, String unit, Long valueOid) {
        this.oid = oid;
        this.unit = unit;
    ...
    public boolean equals(Object that) {
        ...
        SqlIntervalExpr other = (SqlIntervalExpr) that;
