...
public class MySqlBinlogStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_binlog_statement")
    public MySqlBinlogStatement(Long oid, Long exprOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlBinlogStatement other = (MySqlBinlogStatement) that;
