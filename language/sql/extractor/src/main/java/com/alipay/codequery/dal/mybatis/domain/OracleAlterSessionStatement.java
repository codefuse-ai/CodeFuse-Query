...
public class OracleAlterSessionStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_alter_session_statement")
    public OracleAlterSessionStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        OracleAlterSessionStatement other = (OracleAlterSessionStatement) that;
