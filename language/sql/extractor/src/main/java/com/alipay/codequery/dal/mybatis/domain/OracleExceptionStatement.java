...
public class OracleExceptionStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_exception_statement")
    public OracleExceptionStatement(Long oid, String items) {
        this.oid = oid;
        this.items = items;
    }
    ...
    public boolean equals(Object that) {
        ...
        OracleExceptionStatement other = (OracleExceptionStatement) that;
