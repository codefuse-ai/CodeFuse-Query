...
public class MySqlShowCollationStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_collation_statement")
    public MySqlShowCollationStatement(Long oid, Long patternOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowCollationStatement other = (MySqlShowCollationStatement) that;
