...
public class MySqlAlterTableOrderBy implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_alter_table_order_by")
    public MySqlAlterTableOrderBy(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlAlterTableOrderBy other = (MySqlAlterTableOrderBy) that;
