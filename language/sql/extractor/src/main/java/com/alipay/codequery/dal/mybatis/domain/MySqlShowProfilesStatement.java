...
public class MySqlShowProfilesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_profiles_statement")
    public MySqlShowProfilesStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowProfilesStatement other = (MySqlShowProfilesStatement) that;
