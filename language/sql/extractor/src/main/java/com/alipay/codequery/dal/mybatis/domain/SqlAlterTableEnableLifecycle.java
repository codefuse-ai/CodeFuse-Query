...
public class SqlAlterTableEnableLifecycle implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_enable_lifecycle")
    public SqlAlterTableEnableLifecycle(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableEnableLifecycle other = (SqlAlterTableEnableLifecycle) that;
