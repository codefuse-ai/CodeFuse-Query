...
public class MySqlShowCreateFunctionStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_create_function_statement")
    public MySqlShowCreateFunctionStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowCreateFunctionStatement other = (MySqlShowCreateFunctionStatement) that;
