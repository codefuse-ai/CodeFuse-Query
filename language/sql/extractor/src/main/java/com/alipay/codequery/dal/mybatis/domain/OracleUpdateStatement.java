...
public class OracleUpdateStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_update_statement")
    public OracleUpdateStatement(Long oid, String alias, Integer hintsSize, Integer isOnly) {
        this.oid = oid;
        this.alias = alias;
    ...
    public boolean equals(Object that) {
        ...
        OracleUpdateStatement other = (OracleUpdateStatement) that;
