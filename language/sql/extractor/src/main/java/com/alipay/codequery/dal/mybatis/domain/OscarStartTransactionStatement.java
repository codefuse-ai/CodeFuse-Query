...
public class OscarStartTransactionStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oscar_start_transaction_statement")
    public OscarStartTransactionStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        OscarStartTransactionStatement other = (OscarStartTransactionStatement) that;
