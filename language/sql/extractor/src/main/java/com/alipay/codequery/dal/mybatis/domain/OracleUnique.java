...
public class OracleUnique implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_unique")
    public OracleUnique(Long oid, Integer deferrable, Long exceptionsIntoOid, String initially, Long usingOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OracleUnique other = (OracleUnique) that;
