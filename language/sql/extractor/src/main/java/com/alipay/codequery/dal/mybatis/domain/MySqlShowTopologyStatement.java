...
public class MySqlShowTopologyStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_topology_statement")
    public MySqlShowTopologyStatement(Long oid, Integer isFull, Long limitOid, Long nameOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
        this.isFull = isFull;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowTopologyStatement other = (MySqlShowTopologyStatement) that;
