...
public class OscarInsertStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oscar_insert_statement")
    public OscarInsertStatement(Long oid, Integer isDefaultValues, Integer isOnConflictDoNothing, Long onConflictConstraintOid, Long onConflictUpdateWhereOid, Long onConflictWhereOid, Long returningOid, String values, String valuesList) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OscarInsertStatement other = (OscarInsertStatement) that;
