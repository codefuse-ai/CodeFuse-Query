...
public class MySqlShowDatasourcesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_datasources_statement")
    public MySqlShowDatasourcesStatement(Long oid, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowDatasourcesStatement other = (MySqlShowDatasourcesStatement) that;
