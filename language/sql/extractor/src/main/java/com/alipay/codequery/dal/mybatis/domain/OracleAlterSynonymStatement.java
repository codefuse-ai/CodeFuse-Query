...
public class OracleAlterSynonymStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_alter_synonym_statement")
    public OracleAlterSynonymStatement(Long oid, Integer enable, Integer isCompile, Long nameOid) {
        this.oid = oid;
        this.enable = enable;
    ...
    public boolean equals(Object that) {
        ...
        OracleAlterSynonymStatement other = (OracleAlterSynonymStatement) that;
