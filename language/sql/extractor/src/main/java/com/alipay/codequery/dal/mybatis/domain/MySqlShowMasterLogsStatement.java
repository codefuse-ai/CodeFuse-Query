...
public class MySqlShowMasterLogsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_master_logs_statement")
    public MySqlShowMasterLogsStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowMasterLogsStatement other = (MySqlShowMasterLogsStatement) that;
