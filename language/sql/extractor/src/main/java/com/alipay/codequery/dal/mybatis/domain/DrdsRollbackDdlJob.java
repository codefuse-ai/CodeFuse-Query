...
public class DrdsRollbackDdlJob implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: drds_rollback_ddl_job")
    public DrdsRollbackDdlJob(Long oid, String jobIds) {
        this.oid = oid;
        this.jobIds = jobIds;
    }
    ...
    public boolean equals(Object that) {
        ...
        DrdsRollbackDdlJob other = (DrdsRollbackDdlJob) that;
