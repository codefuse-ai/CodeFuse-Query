...
public class OracleContinueStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_continue_statement")
    public OracleContinueStatement(Long oid, String label, Long whenOid) {
        this.oid = oid;
        this.label = label;
    ...
    public boolean equals(Object that) {
        ...
        OracleContinueStatement other = (OracleContinueStatement) that;
