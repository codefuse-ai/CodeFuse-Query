...
public class MySqlShowPlanCacheStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_plan_cache_statement")
    public MySqlShowPlanCacheStatement(Long oid, Long selectOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowPlanCacheStatement other = (MySqlShowPlanCacheStatement) that;
