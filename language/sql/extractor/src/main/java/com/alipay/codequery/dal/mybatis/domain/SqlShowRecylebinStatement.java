...
public class SqlShowRecylebinStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_recylebin_statement")
    public SqlShowRecylebinStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlShowRecylebinStatement other = (SqlShowRecylebinStatement) that;
