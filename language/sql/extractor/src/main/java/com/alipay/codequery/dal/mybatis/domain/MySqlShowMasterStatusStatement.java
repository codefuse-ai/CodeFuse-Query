...
public class MySqlShowMasterStatusStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_master_status_statement")
    public MySqlShowMasterStatusStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowMasterStatusStatement other = (MySqlShowMasterStatusStatement) that;
