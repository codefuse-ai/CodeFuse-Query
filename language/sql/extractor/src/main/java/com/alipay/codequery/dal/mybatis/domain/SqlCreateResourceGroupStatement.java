...
public class SqlCreateResourceGroupStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_create_resource_group_statement")
    public SqlCreateResourceGroupStatement(Long oid, Integer enable, Long nameOid, String properties) {
        this.oid = oid;
        this.enable = enable;
    ...
    public boolean equals(Object that) {
        ...
        SqlCreateResourceGroupStatement other = (SqlCreateResourceGroupStatement) that;
