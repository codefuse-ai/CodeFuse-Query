...
public class SqlDropServerStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_server_statement")
    public SqlDropServerStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropServerStatement other = (SqlDropServerStatement) that;
