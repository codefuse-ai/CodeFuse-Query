...
public class SqlDropResourceGroupStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_resource_group_statement")
    public SqlDropResourceGroupStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropResourceGroupStatement other = (SqlDropResourceGroupStatement) that;
