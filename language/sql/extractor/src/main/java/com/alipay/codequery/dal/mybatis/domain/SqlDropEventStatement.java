...
public class SqlDropEventStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_event_statement")
    public SqlDropEventStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropEventStatement other = (SqlDropEventStatement) that;
