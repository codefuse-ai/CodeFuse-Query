...
public class SqlServerStatementImpl implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_server_statement_impl")
    public SqlServerStatementImpl(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlServerStatementImpl other = (SqlServerStatementImpl) that;
