...
public class SqlAlterTableTruncatePartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_truncate_partition")
    public SqlAlterTableTruncatePartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableTruncatePartition other = (SqlAlterTableTruncatePartition) that;
