...
public class MySqlShowGrantsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_grants_statement")
    public MySqlShowGrantsStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowGrantsStatement other = (MySqlShowGrantsStatement) that;
