...
public class SqlListResourceGroupStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_list_resource_group_statement")
    public SqlListResourceGroupStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlListResourceGroupStatement other = (SqlListResourceGroupStatement) that;
