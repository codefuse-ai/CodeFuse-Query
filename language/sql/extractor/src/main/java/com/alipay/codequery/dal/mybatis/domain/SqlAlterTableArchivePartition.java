...
public class SqlAlterTableArchivePartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_archive_partition")
    public SqlAlterTableArchivePartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableArchivePartition other = (SqlAlterTableArchivePartition) that;
