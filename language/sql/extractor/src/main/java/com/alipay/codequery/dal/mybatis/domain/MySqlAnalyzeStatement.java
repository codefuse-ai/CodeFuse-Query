...
public class MySqlAnalyzeStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_analyze_statement")
    public MySqlAnalyzeStatement(Long oid, Integer isLocal, Integer isNoWriteToBinlog) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlAnalyzeStatement other = (MySqlAnalyzeStatement) that;
