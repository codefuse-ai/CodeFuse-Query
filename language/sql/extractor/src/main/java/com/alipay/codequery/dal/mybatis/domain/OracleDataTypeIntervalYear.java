...
public class OracleDataTypeIntervalYear implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_data_type_interval_year")
    public OracleDataTypeIntervalYear(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        OracleDataTypeIntervalYear other = (OracleDataTypeIntervalYear) that;
