...
public class MySqlRenameTableStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_rename_table_statement")
    public MySqlRenameTableStatement(Long oid, String items) {
        this.oid = oid;
        this.items = items;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlRenameTableStatement other = (MySqlRenameTableStatement) that;
