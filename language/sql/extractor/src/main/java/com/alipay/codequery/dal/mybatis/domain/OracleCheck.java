...
public class OracleCheck implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_check")
    public OracleCheck(Long oid, Integer deferrable, Long exceptionsIntoOid, String initially, Long usingOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OracleCheck other = (OracleCheck) that;
