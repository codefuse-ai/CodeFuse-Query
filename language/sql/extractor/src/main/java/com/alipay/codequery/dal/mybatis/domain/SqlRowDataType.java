...
public class SqlRowDataType implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_row_data_type")
    public SqlRowDataType(Long oid, String fields, Integer isInt, Integer isNumberic, Integer isString, Integer isWithLocalTimeZone, String name, Integer withTimeZone) {
        this.oid = oid;
        this.fields = fields;
        this.isInt = isInt;
    ...
    public boolean equals(Object that) {
        ...
        SqlRowDataType other = (SqlRowDataType) that;
