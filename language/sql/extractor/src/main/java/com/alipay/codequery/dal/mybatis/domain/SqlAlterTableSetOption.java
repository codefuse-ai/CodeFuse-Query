...
public class SqlAlterTableSetOption implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_set_option")
    public SqlAlterTableSetOption(Long oid, Long onOid) {
        this.oid = oid;
        this.onOid = onOid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableSetOption other = (SqlAlterTableSetOption) that;
