...
public class OdpsExstoreStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: odps_exstore_statement")
    public OdpsExstoreStatement(Long oid, Long tableOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OdpsExstoreStatement other = (OdpsExstoreStatement) that;
