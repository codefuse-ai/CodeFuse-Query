...
public class SqlAlterTableRebuildPartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_rebuild_partition")
    public SqlAlterTableRebuildPartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableRebuildPartition other = (SqlAlterTableRebuildPartition) that;
