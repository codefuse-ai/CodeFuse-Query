...
public class MySqlShowBinaryLogsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_binary_logs_statement")
    public MySqlShowBinaryLogsStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowBinaryLogsStatement other = (MySqlShowBinaryLogsStatement) that;
