...
public class SqlPurgeRecyclebinStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_purge_recyclebin_statement")
    public SqlPurgeRecyclebinStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlPurgeRecyclebinStatement other = (SqlPurgeRecyclebinStatement) that;
