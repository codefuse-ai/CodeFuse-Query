...
public class OracleGotoStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_goto_statement")
    public OracleGotoStatement(Long oid, Long labelOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        OracleGotoStatement other = (OracleGotoStatement) that;
