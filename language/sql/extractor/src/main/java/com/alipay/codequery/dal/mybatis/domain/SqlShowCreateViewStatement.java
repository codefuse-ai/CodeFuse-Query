...
public class SqlShowCreateViewStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_create_view_statement")
    public SqlShowCreateViewStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowCreateViewStatement other = (SqlShowCreateViewStatement) that;
