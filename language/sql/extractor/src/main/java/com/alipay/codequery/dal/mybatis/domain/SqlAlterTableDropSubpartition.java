...
public class SqlAlterTableDropSubpartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_drop_subpartition")
    public SqlAlterTableDropSubpartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableDropSubpartition other = (SqlAlterTableDropSubpartition) that;
