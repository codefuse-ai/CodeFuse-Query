...
public class MySqlShowBroadcastsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_broadcasts_statement")
    public MySqlShowBroadcastsStatement(Long oid, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowBroadcastsStatement other = (MySqlShowBroadcastsStatement) that;
