...
public class SqlAlterTableDropPrimaryKey implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_drop_primary_key")
    public SqlAlterTableDropPrimaryKey(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableDropPrimaryKey other = (SqlAlterTableDropPrimaryKey) that;
