...
public class SqlAlterTableReOrganizePartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_re_organize_partition")
    public SqlAlterTableReOrganizePartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableReOrganizePartition other = (SqlAlterTableReOrganizePartition) that;
