...
public class SqlShowVariantsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_variants_statement")
    public SqlShowVariantsStatement(Long oid, Integer isGlobal, Integer isSession, Long likeOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowVariantsStatement other = (SqlShowVariantsStatement) that;
