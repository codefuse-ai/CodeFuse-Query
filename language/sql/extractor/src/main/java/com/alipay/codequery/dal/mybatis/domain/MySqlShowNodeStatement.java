...
public class MySqlShowNodeStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_node_statement")
    public MySqlShowNodeStatement(Long oid, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowNodeStatement other = (MySqlShowNodeStatement) that;
