...
public class SqlRefreshMaterializedViewStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_refresh_materialized_view_statement")
    public SqlRefreshMaterializedViewStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlRefreshMaterializedViewStatement other = (SqlRefreshMaterializedViewStatement) that;
