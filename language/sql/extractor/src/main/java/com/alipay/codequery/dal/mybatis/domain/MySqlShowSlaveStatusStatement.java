...
public class MySqlShowSlaveStatusStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_slave_status_statement")
    public MySqlShowSlaveStatusStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowSlaveStatusStatement other = (MySqlShowSlaveStatusStatement) that;
