...
public class PgLineSegmentsExpr implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_line_segments_expr")
    public PgLineSegmentsExpr(Long oid, Long valueOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        PgLineSegmentsExpr other = (PgLineSegmentsExpr) that;
