...
public class SqlAlterSystemGetConfigStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_system_get_config_statement")
    public SqlAlterSystemGetConfigStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterSystemGetConfigStatement other = (SqlAlterSystemGetConfigStatement) that;
