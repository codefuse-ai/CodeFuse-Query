...
public class MySqlShowFunctionCodeStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_function_code_statement")
    public MySqlShowFunctionCodeStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowFunctionCodeStatement other = (MySqlShowFunctionCodeStatement) that;
