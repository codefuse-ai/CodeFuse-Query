...
public class SqlShowCatalogsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_catalogs_statement")
    public SqlShowCatalogsStatement(Long oid, Long likeOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowCatalogsStatement other = (SqlShowCatalogsStatement) that;
