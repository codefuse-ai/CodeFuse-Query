...
public class SqlAlterTableSetLifecycle implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_set_lifecycle")
    public SqlAlterTableSetLifecycle(Long oid, Long lifecycleOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableSetLifecycle other = (SqlAlterTableSetLifecycle) that;
