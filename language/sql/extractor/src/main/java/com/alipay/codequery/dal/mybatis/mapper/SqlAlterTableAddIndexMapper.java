...
import static com.alipay.codequery.dal.mybatis.mapper.SqlAlterTableAddIndexDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.alipay.codequery.dal.mybatis.domain.SqlAlterTableAddIndex;
...
@Mapper
public interface SqlAlterTableAddIndexMapper {
    ...
    int insert(InsertStatementProvider<SqlAlterTableAddIndex> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    @InsertProvider(type=SqlProviderAdapter.class, method="insertMultiple")
    int insertMultiple(MultiRowInsertStatementProvider<SqlAlterTableAddIndex> multipleInsertStatement);
    ...
    Optional<SqlAlterTableAddIndex> selectOne(SelectStatementProvider selectStatement);
    ...
    List<SqlAlterTableAddIndex> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, sqlAlterTableAddIndex, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, sqlAlterTableAddIndex, completer);
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int insert(SqlAlterTableAddIndex record) {
        return MyBatis3Utils.insert(this::insert, record, sqlAlterTableAddIndex, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int insertMultiple(Collection<SqlAlterTableAddIndex> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, sqlAlterTableAddIndex, c ->
            c.map(oid).toProperty("oid")
            .map(algorithm).toProperty("algorithm")
            .map(commentOid).toProperty("commentOid")
            .map(dbPartitionByOid).toProperty("dbPartitionByOid")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int insertSelective(SqlAlterTableAddIndex record) {
        return MyBatis3Utils.insert(this::insert, record, sqlAlterTableAddIndex, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default Optional<SqlAlterTableAddIndex> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, sqlAlterTableAddIndex, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default List<SqlAlterTableAddIndex> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, sqlAlterTableAddIndex, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default List<SqlAlterTableAddIndex> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, sqlAlterTableAddIndex, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default Optional<SqlAlterTableAddIndex> selectByPrimaryKey(Long oid_) {
        return selectOne(c ->
            c.where(oid, isEqualTo(oid_))
        );
    }
    ...
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, sqlAlterTableAddIndex, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    static UpdateDSL<UpdateModel> updateAllColumns(SqlAlterTableAddIndex record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(SqlAlterTableAddIndex record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int updateByPrimaryKey(SqlAlterTableAddIndex record) {
        return update(c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_add_index")
    default int updateByPrimaryKeySelective(SqlAlterTableAddIndex record) {
        return update(c ->
