...
public class PgCreateSchemaStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_create_schema_statement")
    public PgCreateSchemaStatement(Long oid, Integer isAuthorization, Integer isIfNotExists, Long schemaNameOid, Long userNameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        PgCreateSchemaStatement other = (PgCreateSchemaStatement) that;
