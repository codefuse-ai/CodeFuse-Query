...
public class OraclePipeRowStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: oracle_pipe_row_statement")
    public OraclePipeRowStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        OraclePipeRowStatement other = (OraclePipeRowStatement) that;
