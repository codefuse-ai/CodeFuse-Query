...
public class SqlAlterTableAddIndex implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableAddIndex other = (SqlAlterTableAddIndex) that;
