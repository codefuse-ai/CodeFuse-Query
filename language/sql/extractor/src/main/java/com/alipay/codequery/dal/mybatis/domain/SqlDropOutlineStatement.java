...
public class SqlDropOutlineStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_drop_outline_statement")
    public SqlDropOutlineStatement(Long oid, Integer isIfExists, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlDropOutlineStatement other = (SqlDropOutlineStatement) that;
