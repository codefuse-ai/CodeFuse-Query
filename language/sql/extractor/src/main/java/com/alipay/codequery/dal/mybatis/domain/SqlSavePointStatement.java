...
public class SqlSavePointStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_save_point_statement")
    public SqlSavePointStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlSavePointStatement other = (SqlSavePointStatement) that;
