...
public class MySqlCreateEventStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_create_event_statement")
    public MySqlCreateEventStatement(Long oid, Long commentOid, Long definerOid, Integer enable, Long eventBodyOid, Integer isDisableOnSlave, Integer isIfNotExists, Integer isOnCompletionPreserve, Long nameOid, Long renameToOid, Long scheduleOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlCreateEventStatement other = (MySqlCreateEventStatement) that;
