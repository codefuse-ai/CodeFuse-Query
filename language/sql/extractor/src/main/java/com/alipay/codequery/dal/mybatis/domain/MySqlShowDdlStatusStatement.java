...
public class MySqlShowDdlStatusStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_ddl_status_statement")
    public MySqlShowDdlStatusStatement(Long oid, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowDdlStatusStatement other = (MySqlShowDdlStatusStatement) that;
