...
public class MySqlShowConfigStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_config_statement")
    public MySqlShowConfigStatement(Long oid, Long nameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowConfigStatement other = (MySqlShowConfigStatement) that;
