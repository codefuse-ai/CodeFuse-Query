...
public class MySqlAlterTableImportTablespace implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_alter_table_import_tablespace")
    public MySqlAlterTableImportTablespace(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlAlterTableImportTablespace other = (MySqlAlterTableImportTablespace) that;
