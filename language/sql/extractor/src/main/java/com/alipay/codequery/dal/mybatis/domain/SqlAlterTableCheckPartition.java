...
public class SqlAlterTableCheckPartition implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_alter_table_check_partition")
    public SqlAlterTableCheckPartition(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlAlterTableCheckPartition other = (SqlAlterTableCheckPartition) that;
