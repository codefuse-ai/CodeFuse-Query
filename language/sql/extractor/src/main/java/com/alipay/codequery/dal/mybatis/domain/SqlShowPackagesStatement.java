...
public class SqlShowPackagesStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_packages_statement")
    public SqlShowPackagesStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlShowPackagesStatement other = (SqlShowPackagesStatement) that;
