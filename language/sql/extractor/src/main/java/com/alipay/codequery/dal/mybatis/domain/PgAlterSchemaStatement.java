...
public class PgAlterSchemaStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_alter_schema_statement")
    public PgAlterSchemaStatement(Long oid, Long newNameOid, Long newOwnerOid, Long schemaNameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        PgAlterSchemaStatement other = (PgAlterSchemaStatement) that;
