...
public class SqlSubPartitionByRange implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_sub_partition_by_range")
    public SqlSubPartitionByRange(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlSubPartitionByRange other = (SqlSubPartitionByRange) that;
