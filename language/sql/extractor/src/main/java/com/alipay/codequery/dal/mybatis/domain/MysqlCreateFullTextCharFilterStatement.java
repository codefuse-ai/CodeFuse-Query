...
public class MysqlCreateFullTextCharFilterStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: mysql_create_full_text_char_filter_statement")
    public MysqlCreateFullTextCharFilterStatement(Long oid, Long nameOid, Long typeNameOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        MysqlCreateFullTextCharFilterStatement other = (MysqlCreateFullTextCharFilterStatement) that;
