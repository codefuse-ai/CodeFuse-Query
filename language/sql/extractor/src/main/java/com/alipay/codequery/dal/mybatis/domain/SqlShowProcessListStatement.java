...
public class SqlShowProcessListStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_process_list_statement")
    public SqlShowProcessListStatement(Long oid, Integer isFull, Integer isMpp, Long limitOid, Long orderByOid, Long whereOid) {
        this.oid = oid;
        this.isFull = isFull;
        this.isMpp = isMpp;
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: sql_show_process_list_statement.is_mpp")
    public Integer getIsMpp() {
        return isMpp;
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: sql_show_process_list_statement.is_mpp")
    public void setIsMpp(Integer isMpp) {
        this.isMpp = isMpp;
    }
    ...
    public boolean equals(Object that) {
        ...
        SqlShowProcessListStatement other = (SqlShowProcessListStatement) that;
        return (this.getOid() == null ? other.getOid() == null : this.getOid().equals(other.getOid()))
            && (this.getIsFull() == null ? other.getIsFull() == null : this.getIsFull().equals(other.getIsFull()))
            && (this.getIsMpp() == null ? other.getIsMpp() == null : this.getIsMpp().equals(other.getIsMpp()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsMpp() == null) ? 0 : getIsMpp().hashCode());
