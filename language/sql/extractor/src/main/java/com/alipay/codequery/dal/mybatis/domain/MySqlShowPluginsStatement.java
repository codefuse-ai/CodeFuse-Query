...
public class MySqlShowPluginsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: my_sql_show_plugins_statement")
    public MySqlShowPluginsStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        MySqlShowPluginsStatement other = (MySqlShowPluginsStatement) that;
