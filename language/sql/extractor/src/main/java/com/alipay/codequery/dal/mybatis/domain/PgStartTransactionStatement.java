...
public class PgStartTransactionStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: pg_start_transaction_statement")
    public PgStartTransactionStatement(Long oid) {
        this.oid = oid;
    }
    ...
    public boolean equals(Object that) {
        ...
        PgStartTransactionStatement other = (PgStartTransactionStatement) that;
