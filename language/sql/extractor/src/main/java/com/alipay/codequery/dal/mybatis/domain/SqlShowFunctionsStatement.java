...
public class SqlShowFunctionsStatement implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: sql_show_functions_statement")
    public SqlShowFunctionsStatement(Long oid, Long likeOid) {
        this.oid = oid;
    ...
    public boolean equals(Object that) {
        ...
        SqlShowFunctionsStatement other = (SqlShowFunctionsStatement) that;
