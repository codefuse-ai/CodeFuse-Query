...
import type * as coref from "./index";
import type * as prisma from "@prisma/client";

export interface CorefLiteral {
...
export interface CorefTypeNode {
...
export interface CorefBindingPattern {
...
export interface CorefDeclaration {
...
export interface CorefExpression {
...
export interface CorefStatement {
...
export interface CorefOtherAstNode {
 ...
 * COREF AST
 */
export interface CorefAst
  extends CorefLiteral,
    CorefToken,
    CorefName,
    CorefTypeNode,
    CorefMember,
 ...
 * COREF
 */
export interface Coref extends CorefAst {
  files: prisma.file[];
  ...
  typeMap: Map<bigint, prisma.type_>;
  nodeTypeMap: Map<bigint, bigint>;
}
